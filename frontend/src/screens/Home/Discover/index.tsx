...
const Discover = () => {
  ...
  const [date, setDate] = useState<string>(dateOptions[0]);
  const [price, setPrice] = useState<string>(priceOptions[0]);
  const [likes, setLikes] = useState<string>(likesOptions[0]);
  const [creator, setCreator] = useState<string>(creatorOptions[0]);
        ...
        <div className={styles.top}>
          ...
          >
            ...
            <div className={styles.toggle}>
              <Icon title="filter" size={18} />
              <Icon title="close" size={10} />
            </div>
          </button>
        </div>
